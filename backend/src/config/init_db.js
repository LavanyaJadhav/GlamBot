  ...
  try {
    ...
    await connection.execute(`
      CREATE TABLE IF NOT EXISTS Style_Profile (
        ...
        style_1_percentage INT NOT NULL,
        style_2 VARCHAR(50) NOT NULL,
        style_2_percentage INT NOT NULL,
        style_3 VARCHAR(50) NOT NULL,
        style_3_percentage INT NOT NULL,
        style_4 VARCHAR(50) NOT NULL,
        style_4_percentage INT NOT NULL,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        FOREIGN KEY (user_id) REFERENCES Users(user_id)
      )
    `);
    ...
    // Insert sample users
    await connection.query(`
      INSERT INTO Users (name, email, password, fashion_preference)
      VALUES 
        ('John Doe', 'root1@gmail.com', 'root1', 'casual'),
        ('Jane Smith', 'root2@gmail.com', 'root1', 'formal'),
        ('Mike Johnson', 'root3@gmail.com', 'root1', 'sporty'),
        ('Sarah Williams', 'root4@gmail.com', 'root1', 'bohemian')
    `);
