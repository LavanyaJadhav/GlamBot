...
export default function JacketRecommendationsPage() {
  ...
  const recommendations = [
    {
      id: 1,
      title: "Mustard Yellow Bomber Jacket",
      price: 1599,
      image: "https://m.media-amazon.com/images/I/71cFpnm0D6L._SX522_.jpg",
      link: "https://www.amazon.in/LEOTUDE-Sleeve-Regular-Bomber-02_BOMBER_MSTD_P_Mustard_XL/dp/B0CNSX6LNY/",
    ...
    },
    {
      ...
      link: "https://www.amazon.in/Crimsoune-Club-Cropped-Mustard-Leather/dp/B0BTPQVZHS/",
    ...
    },
    {
      ...
      link: "https://www.amazon.in/Scott-International-Lightweight-Repellant-SS23_TWRAP-JKT-BL_Large/dp/B0CPJ4XBV5/",
    ...
    },
    {
      ...
      link: "https://www.amazon.in/DIGIMAX-LEATHER-Leather-Length-Regular/dp/B0DDTCB8CV/",
      ...
      <main className="flex-1 py-6 px-4 md:px-6">
        <div className="flex flex-col gap-4 md:gap-8">
          <div className="flex items-center gap-4">
            <h1 className="text-2xl font-bold">Jacket Recommendations</h1>
